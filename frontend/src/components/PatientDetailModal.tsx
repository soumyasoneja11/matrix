        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className={`sticky top-0 z-10 px-6 py-4 flex items-center justify-between border-b ${
              isLight ? 'bg-white border-gray-100' : 'bg-slate-900 border-white/10'
            }`}>
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              {patient.vitals && (
                <section>
                  <h3 className={`text-[11px] font-semibold uppercase tracking-wider mb-2 flex items-center gap-1.5 ${
                    isLight ? 'text-gray-400' : 'text-white/40'
                  }`}>
                    <FaHeartbeat className={isLight ? 'text-red-400' : 'text-red-400'} size={12} />
                    Vitals
                  </h3>
              ...
              <section>
                ...
                <div className={`px-4 py-3 rounded-xl text-sm font-mono leading-relaxed ${
