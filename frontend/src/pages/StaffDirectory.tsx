  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-3xl font-bold gradient-text">Staff Directory</h1>
        <p className="text-white/60 mt-2">Connect with your team members</p>
      </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3 mt-3">
                  <FaPhone className="text-white/40 hover:text-primary-400 cursor-pointer transition-colors" />
                  <FaEnvelope className="text-white/40 hover:text-primary-400 cursor-pointer transition-colors" />
                </div>
              </div>
